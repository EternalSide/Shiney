                                    ...
                                    {products.map((product: ILocalProduct) => {
                                          return (
                                                <div className="flex-1 w-full" key={product.id}>
                                                      <div className="flex items-center gap-1.5 mb-3 ml-3">
                                                            <p className="font-semibold text-[#626d7a]">Магазин:</p>
                                                            <Link href={`/shop/${product.shopLink}`}>
                                                                  <button className="bg-white flex items-center gap-2.5 py-1.5 px-4 rounded-2xl">
                                                                        <Image
                                                                        ...
                                                                        />
                                                                        <h3 className="text-sky-500 font-semibold">{product.shopName}</h3>
                                                                  </button>
                                                            </Link>
                                                      </div>
                                                      <div className="bg-white rounded-lg w-full p-5 flex items-center justify-between">
                                                            <div className="flex gap-2.5 items-center">
                                                                  ...
                                                                  <div className="">
                                                                        <Link href={"/"}>
                                                                              <h3 className="font-bold text-lg hover:text-sky-500 transition">
                                                                                    {product.title}
                                                                              </h3>
                                                                        </Link>
