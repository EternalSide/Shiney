                  ...
                  <div className="font-medium text-sm text-[#626d7a]">
                        <div className="mt-4">
                              <div className="flex flex-col gap-1.5">
                                    ...
                                    <p>После создания магазина вы сможете добавлять товары, управлять им и кастомизировать его.</p>
                                    <p>Если пользователь совершит у вас покупку, вы получите об этом уведомление.</p>
