      ...
      return (
            <div className="flex justify-between w-full items-start border-b py-3 KorzinaCard">
                  <div className="flex items-center gap-1.5">
                        ...
                        <div>
                              <Link href={"/"}>
                                    <h3 className="font-semibold hover:text-sky-500 transition">{title}</h3>
                              </Link>
                              <p className="mt-0.5 text-xs text-[#626d7a] font-medium line-clamp-1 max-w-[250px]">{description}</p>
                        </div>
                  </div>
                  <div className="flex flex-col items-end">
                        ...
                        <div className="mt-3 flex items-center gap-3">
                              <div className="border px-2.5 py-1.5 rounded-lg flex items-center justify-center cursor-default">
                                    ...
                                    <Input className="px-0 text-center border-none !text-black h-4 w-[40px]" value={localQuantity} />
