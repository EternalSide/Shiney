...
const DeleteShopModal = () => {
	...
	return (
		<Dialog open={modalOpen} onOpenChange={onClose}>
			<DialogContent className="bg-white dark:bg-neutral-900 dark:border-transparent">
				<DialogHeader>
					<DialogTitle className="text-center text-2xl dark:text-white">
						Вы уверены?
					</DialogTitle>
				</DialogHeader>
				<DialogDescription className="text-zinc-700 text-center dark:text-zinc-400">
					После подтверждения будут удалены все товары магазина, а также связанная с ним
					информация. Возможность отмены данного действия отсутствует.
				</DialogDescription>
