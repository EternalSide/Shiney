...
const ShopHeader = ({
      ...
      const [optimisticState, addOptimistic] = useOptimistic(isFollowing, (currentState: boolean, optimisticValue: boolean) => {
      ...
      return (
            <div className="p-6 flex justify-between items-start  max-lg:flex-col max-lg:gap-6 bg-white rounded-tr-none rounded-tl-none">
                  <div className="flex items-center gap-3">
                        <button onClick={openAvatar} className="h-28 w-28 relative -mt-24 border-[4px] border-white rounded-full">
                              <Image
                              ...
                              <div className="flex items-center gap-1.5">
                                    ...
                                    <div className="flex items-center gap-3">
                                          ...
                                          <Link href={`/shop/${shopLink}/reviews`}>
                                                <p className="font-semibold text-sky-500 text-sm">{commentsLength} Отзывов</p>
                                          </Link>
                                    </div>
                              </div>
                              <p className="text-sm font-semibold">
                                    На <span className="text-sky-500 font-bold">Shiney</span> {formatDateString(createdOn)}
                              </p>
                        </div>
                  </div>
                  ...
                  <div className="flex items-start gap-10  max-md:flex-col-reverse max-md:gap-3">
                        <div className="flex gap-10 items-center">
                              ...
                              <div className="text-center  mt-1">
                                    ...
                                    <p className="text-zinc-600 text-xs font-semibold mt-1">Подписчиков</p>
                              </div>
                        </div>
